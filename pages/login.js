      ...
      <View style={styles.mainView}>
        <Container style={styles.Container}>
          ...
          <View style={styles.content}>
            <Headline style={styles.header}>تسجيل الدخول</Headline>
          </View>
          ...
          <View style={styles.form}>
            <TextInput style={styles.inputs} label="الرقم السري" type="flat" />
          </View>
          <View style={StyleSheet.compose(styles.form, styles.row)}>
            <RadioButton
              value={checked}
